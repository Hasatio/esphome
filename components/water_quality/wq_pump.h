...
void set_Pump_Calibration(bool pc[])            { for (size_t i = 0; i < 6; i++) Pump_Calibration[i] = pc[i]; }
...
bool* get_Pump_Calibration()            { return Pump_Calibration; }
