...
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// //  ADS1115
// void WQ_I2C::ADS1115_Setup(uint8_t address)
// {
//     parent_->set_i2c_address(address);
...
//     if (!parent_->read_byte_16(ADS1115_REGISTER_CONVERSION, &value))
//     {
//         parent_->mark_failed();
//         return;
//     }
...
//     if (!parent_->write_byte_16(ADS1115_REGISTER_CONFIG, config))
//     {
//         parent_->mark_failed();
//         return;
//     }
...
//         {
//             uint32_t start = millis();
//             while (parent_->read_byte_16(ADS1115_REGISTER_CONFIG, &config) && (config >> 15) == 0)
//             {
//                 if (millis() - start > 100)
//                 {
//                     ESP_LOGW(TAG, "Reading ADS1115 timed out");
...
//     if (!parent_->read_byte_16(ADS1115_REGISTER_CONVERSION, &raw_conversion)) {
//         parent_->status_set_warning();
//         return NAN;
//     }
...
// }
// void WQ_I2C::ADS1115_Driver(float analog_voltage[])
// {
//     parent_->set_i2c_address(ADS1X15_ADDRESS1);
//     if (parent_->is_failed())
//         return;
...
//     parent_->set_i2c_address(ADS1X15_ADDRESS2);
//     if (parent_->is_failed())
//         return;
