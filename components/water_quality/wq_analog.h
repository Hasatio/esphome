...
void set_PH_Volt(float ph)                      { phVoltage = ph; }
...
void set_EC_Volt(float ec)                      { ecVoltage = ec; }
...
float get_PH_Volt()                     { return phVoltage; }
...
float get_EC_Volt()                     { return ecVoltage; }
...
float AnInPH_Val = 0;
float phVoltage = 0, phCalVoltage = 0;
uint8_t AnInEC_Ch = 0, AnInEC_Type = 0;
float AnInEC_Cal[2][2] = {0};
float AnInEC_Val = 0;
float ecVoltage = 0, ecCalVoltage = 0;
