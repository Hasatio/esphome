...
void set_PH_EC_Calibration(bool cal)            { PH_EC_Calibration = cal; }
...
float get_PH_EC_Calibration()           { return PH_EC_Calibration; }
float get_PH_Cal()                      { return AnInEC_Cal; }
